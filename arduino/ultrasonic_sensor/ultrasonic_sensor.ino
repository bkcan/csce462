#define DIR_PIN_Rotating 12
#define STEP_PIN_Rotating 13
...
void loop() {
  ...
  if ((distance_R > 5 && distance_R < 25) && (distance_L > 5 && distance_L < 25))
  {
  ...
  {
    rotateDeg_Up(-10, 0.03);
  }
  else if (distance_D > 5 && distance_D < 25)
  {
    rotateDeg_Down(10, 0.03);
  }
